...
<div className="mb-8 text-center">
  <h2 className="text-3xl font-bold text-slate-900 mb-2">Acceso Administrativo</h2>
  <p className="text-slate-600">Ingrese sus credenciales para acceder al panel</p>
</div>
...
<button
  type="submit"
  className="w-full bg-gradient-to-r from-purple-600 via-pink-500 to-blue-600 text-white py-3 px-4 rounded-lg font-medium hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 transition-all duration-200"
>
  Iniciar Sesión
</button>
            ...
            <>
              {/* Encabezado Registro */}
              <div className="mb-6">
                <h2 className="text-2xl font-bold text-slate-900 mb-2">Registro Administrativo</h2>
                <p className="text-slate-600">Complete la información para crear su cuenta</p>
              </div>
...
<button
  type="submit"
  className="w-full bg-gradient-to-r from-purple-600 via-pink-500 to-blue-600 text-white py-3 px-4 rounded-lg font-medium hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 transition-all duration-200 mt-6"
>
  Crear Cuenta
</button>
