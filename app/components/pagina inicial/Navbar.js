...
export default function Navbar() {
  return (
    <nav className="bg-gradient-to-r from-purple-700 via-purple-600 to-pink-600 text-white p-4 flex justify-between items-center shadow-xl backdrop-blur-sm border-b border-purple-400/20">
