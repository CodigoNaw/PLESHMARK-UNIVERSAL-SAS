...
export default function PqrsPage() {
  ...
  const [activeMenuItem, setActiveMenuItem] = useState("PQRS");
...
<main className="flex-1 ml-0 p-8 bg-gradient-to-br from-slate-50 via-gray-50 to-purple-50/30 overflow-y-auto min-h-screen">
  {/* Header mejorado */}
  <div className="mb-10">
