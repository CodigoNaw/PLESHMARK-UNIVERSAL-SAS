export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 mb-32">
      ...
      <div className="absolute bottom-0 left-0 w-full h-[65px] ">
        <div className="text-center space-y-1 gap-8 flex items-center justify-center text-white">
          <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-2xl shadow-2xl px-8 py-6 text-center border border-purple-400 backdrop-blur-sm bg-opacity-95 w-[400px] h-[130px] flex flex-col justify-center transform hover:scale-105 transition-transform duration-200">
